        ...
        <div className="p-6 grid gap-4">
          <div className="prose prose-invert prose-sm">
            <p className="text-gray-800">
              I am a full-stack developer, having great interest in building modern, responsive web applications. I specialize in JavaScript, React, Next.js, Node.js, Express.js, and MongoDB, creating intuitive and visually appealing user interfaces.
            </p>
          </div>
